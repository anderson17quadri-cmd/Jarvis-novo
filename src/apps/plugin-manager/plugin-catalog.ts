...
export const PLUGIN_CATALOG: readonly CatalogEntry[] = [
  ...
  },
  {
    ...
    icon: FolderOpen,
    category: 'desenvolvimento',
    permissions: { ...NO_PERMISSIONS, storage: true, notifications: true },
    installs: 1,
    rating: 5,
    isBuiltIn: false,
    requires: ['nativeStorage'],
  ...
  },
  {
    ...
    category: 'desenvolvimento',
    permissions: { ...NO_PERMISSIONS, widgets: true, notifications: true },
    installs: 1,
    rating: 5,
    isBuiltIn: false,
    requires: [],
  ...
  },
  {
    ...
    category: 'desenvolvimento',
    permissions: { ...NO_PERMISSIONS, settings: true, notifications: true },
    installs: 1,
    rating: 5,
    isBuiltIn: false,
    requires: [],
  ...
  },
  {
    ...
    icon: PanelRight,
    category: 'desenvolvimento',
    permissions: { ...NO_PERMISSIONS, panels: true, notifications: true },
    installs: 1,
    rating: 5,
    isBuiltIn: false,
    requires: [],
...
export const CAPABILITY_LABELS: Record<keyof PlatformCapabilities, string> = {
  ...
  directControl: 'controlo direto do sistema',
};

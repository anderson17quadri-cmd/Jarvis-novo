...
| **Carregamento real de plugins** — sandbox, assinatura, ficheiros | `apps/plugin-manager/`, `plugins/plugin.ts` | 🟡 assinatura implementada; ficheiros e marketplace continuam bloqueados |
...
| **Instalar plugin de ficheiro local** | ⬜ | Bloqueado — depende desta peça de assinatura (Peça 5), agora concluída |

...
| Comandos naturais compreendidos | ✅ | Com a DeepSeek ligada, **o modelo escolhe as ações** de um catálogo de 29 ferramentas, e encadeia-as: um pedido pode abrir uma janela, criar uma tarefa e mudar de tema de uma vez. Sem modelo, continua o interpretador de padrões |

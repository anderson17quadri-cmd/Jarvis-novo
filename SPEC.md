...
| Wake word configurável | 🟡 | **Decidido e desenhado 15/08/2026 (item 24, opção (a))** — motor local (Vosk, português), nunca escuta contínua por um serviço de fala na nuvem. Desenho em [`docs/spec/wake-word-local.md`](docs/spec/wake-word-local.md). Por construir |
